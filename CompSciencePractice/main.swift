...
//ConsecutiveSum().exec()
//QuickSort().exec()
//MaximumSubarray().exec()
//RotateMatrix().exec()
//InsertionSort().exec()
//MaximumToys().exec()
//FraudulentActivityNotifications().exec()
//CountSort().exec()
//HeightOfTree().exec()
...
//Palindrome().exec()
//FindTheNearestClone().exec()
//IceCreamParlor().exec()
//SortStack().exec()
//Staircases().exec()
//Crossword().exec()
//BuildMinimalHeightBinaryTree().exec()
//LinkedListsFromTree().exec()
//IsBalancedBinaryTree().exec()
//BinaryTreeGetAllPossibleArrays().exec()
//ThreeSum().exec()
//CountInversions().exec()
//MergeSort().exec()
//Pairs().exec()
//TripleSum().exec()
//MinimumTimeRequired().exec()
MaximumSubarray().exec()
